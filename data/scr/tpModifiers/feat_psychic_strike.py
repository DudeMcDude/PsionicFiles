...
def PsyStrikeEffectTooltip(attachee, args, evt_obj):
  ...
  if not isEmbued:
    return 0
  evt_obj.append(tpdp.hash("PSY_STRIKE"), -2, "") # 53 is the indicator graphical index; buffs (indicators above portraits) are in the 0-89 range IIRC; will have to expand this to support new icons
  return 0
