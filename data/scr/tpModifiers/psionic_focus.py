...
def PsiFocusEffectTooltip(attachee, args, evt_obj):
	if not IsFocused(args):
		return 0
	evt_obj.append(tpdp.hash("PSI_FOCUS"), -2, "Psionically Focused") # 53 is the indicator graphical index; buffs (indicators above portraits) are in the 0-89 range IIRC; will have to expand this to support new icons
	return 0
