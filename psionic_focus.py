...
#psiFocus.AddHook(?, ?, PsionicFocusLost, ()) 													 # hook PsionicFocusLost to event of having 0 psi points
...
# TODO fix the radial building function, it will work on EVERY pc in the game, internal to function only makes it work if PC has current psi points and concentration points
